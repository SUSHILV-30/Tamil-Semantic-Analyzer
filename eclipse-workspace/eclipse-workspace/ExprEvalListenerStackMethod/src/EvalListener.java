...
public class EvalListener extends ExprBaseListener {
    ...
    public EvalListener(){
    	memoryTable.put("a", 2.0);
    	memoryTable.put("b", 3.0);
    }
    ...
    public void exitIdExpr(ExprParser.IdExprContext ctx) {
    	...
    	if(!memoryTable.containsKey(varName)) {
    		throw new RuntimeException("Variable not Found!");
    		
    	}
    	
    	stack.push(memoryTable.get(varName));
