...
public interface TamilListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link TamilParser#sent}.
	 * @param ctx the parse tree
	 */
	void enterSent(TamilParser.SentContext ctx);
	/**
	 * Exit a parse tree produced by {@link TamilParser#sent}.
	 * @param ctx the parse tree
	 */
	void exitSent(TamilParser.SentContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link TamilParser#day}.
	 * @param ctx the parse tree
	 */
	void enterDay(TamilParser.DayContext ctx);
	/**
	 * Exit a parse tree produced by {@link TamilParser#day}.
	 * @param ctx the parse tree
	 */
	void exitDay(TamilParser.DayContext ctx);
	/**
	 * Enter a parse tree produced by {@link TamilParser#month}.
	 * @param ctx the parse tree
	 */
	void enterMonth(TamilParser.MonthContext ctx);
	/**
	 * Exit a parse tree produced by {@link TamilParser#month}.
	 * @param ctx the parse tree
	 */
	void exitMonth(TamilParser.MonthContext ctx);
	/**
